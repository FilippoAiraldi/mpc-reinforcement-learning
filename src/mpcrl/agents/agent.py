...
class Agent(
    ...
    def state_value(
        ...
        state: Union[
            ...
            Iterable[dict[str, npt.ArrayLike]],
        ],
        ...
        **kwargs,
        ...
        Parameters
        ----------
        state : array_like or dict[str, array_like], or iterable of either
            ...
            all the states. Pass an iterable of either for vectorized environments.
