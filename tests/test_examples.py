...
class TestExamples(unittest.TestCase):
    def test_q_learning(self):
        ...
        np.testing.assert_allclose(J, d["q_learning_J"], rtol=1e-6, atol=1e-6)
        np.testing.assert_allclose(X, d["q_learning_X"], rtol=1e-6, atol=1e-6)
        np.testing.assert_allclose(U, d["q_learning_U"], rtol=1e-6, atol=1e-6)
        np.testing.assert_allclose(R, d["q_learning_R"], rtol=1e-6, atol=1e-6)
        np.testing.assert_allclose(TD, d["q_learning_TD"], rtol=1e-6, atol=1e-6)
