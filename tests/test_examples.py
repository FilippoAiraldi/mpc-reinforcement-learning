...
class TestExamples(unittest.TestCase):
    ...
    def test_dpg__with_copy_and_pickle(self, use_copy: bool):
        ...
        np.testing.assert_allclose(U, DATA["dpg_U"], rtol=1e-6, atol=1e-3)
        np.testing.assert_allclose(R, DATA["dpg_R"], rtol=1e-6, atol=1e-3)
        np.testing.assert_allclose(Jest, DATA["dpg_Jest"], rtol=1e2, atol=1e2)
